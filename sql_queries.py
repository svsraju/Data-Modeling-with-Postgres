...
songplay_table_create = ("CREATE TABLE IF NOT EXISTS songplays (songplayid varchar,\
                        start_time varchar, user_id int not null, level varchar, song_id varchar, artist_id varchar, session_id int, location text, user_agent text);")
